    ...
    <div>
      ...
      <div className='mx-auto max-w-2xl py-16 px-4 sm:py-24 sm:px-6 lg:max-w-7xl lg:px-8 '>
        <div className='flex justify-around'>
          <h2 className='text-2xl font-bold tracking-tight text-gray-900'>My Projects</h2>
          ...
          projects.map((project, i) => (
            <div key={i} className='group relative border-2 rounded-lg'>
              ...
              <div className=' mt-4 '>
                ...
                <div className='m-4'>
                  Description:
                  <p className='text-gray-500 my-2 mx-1 inline'>{project.projectDescription}</p>
                </div>
                <div className='mx-4'>
                  GitHub:
                  <a href={project.githubUrl} className='text-gray-500 my-2 mx-1 inline'>
                    {project.githubUrl}
                  </a>
                </div>
                <div className='mx-4 mb-4'>
                  LiveSite:
                  <a href={project.liveSiteUrl} className='text-gray-500 my-2 mx-1 inline'>
                    {project.liveSiteUrl}
                  </a>
                </div>
              </div>
